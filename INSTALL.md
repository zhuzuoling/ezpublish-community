...
5. Install the dependencies with [Composer](http://getcomposer.org).
       ...
       **Note: The following step will also install assets, if you prefer to install assets using symlink
               instead of default hard copy so you don't have to re do it on changes, edit 'symfony-assets-install'
